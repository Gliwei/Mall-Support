...
@Repository
public class Commodity2propertyitemDao extends BaseDao<Commodity2propertyitem, String> {
	...
	public List<Commodity2propertyitem> query(String commodityId, String propertyitemId) {
