				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group itemlist">
							...
							<div class="controls">
								<ul class="flat">
									<c:forEach items="${entity.propertyitems}" var="propertyitem" varStatus="idx">
										<li>
											<input type="text" name="itemName" value="${propertyitem.itemName}"><i class="fa fa-save save" onClick="save(this,${propertyitem.id})"></i><i class="fa fa-times delete" title="删除" onClick="del(this)"></i>
										</li>
									</c:forEach>
