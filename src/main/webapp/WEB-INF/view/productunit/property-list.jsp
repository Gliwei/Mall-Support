...
<body>
    ...
    <div class="c-tit">
        ...
        <form action="${rootPath}property/search" method="get" id="search-form">
        ...
        <a href="${rootPath}property/editpage">
    ...
    <table class="simple-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                	<a href="${rootPath}property/editpage?id=${entity.id}"><i class="icon-edit"></i></a>
    ...
    <c:import url="../common/page.jsp">
    	<c:param name="url" value="${rootPath}property/list/" />
    </c:import>
</body>
</html> 